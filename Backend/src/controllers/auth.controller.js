...
export async function register(req, res) {
    ...
    await sendEmail({
        ...
        <a href="https://lab-assistant-kivm.onrender.com/api/auth/verify-email?token=${emailVerificationToken}">Verify Email</a>
...
export async function verifyEmail(req, res) {
  ...
  <a href="https://lab-assistant-1.onrender.com/login">Go to Login</a>
  `
  res.send(html);
}
